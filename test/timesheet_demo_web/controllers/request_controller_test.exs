defmodule TimesheetDemoWeb.RequestControllerTest do
  use TimesheetDemoWeb.ConnCase

  alias TimesheetDemo.Requests

  @create_attrs %{approval: true, date: ~D[2010-04-17], name: "some name"}
